...
ros::Publisher pos_cmd_pub, pos_icuas_pub;
...
void cmdCallback(const ros::TimerEvent &e)
{
  ...
  trans1.rotation.x = 0;
  trans1.rotation.y = 0;
  trans1.rotation.z = sin(cmd.yaw/2);
  trans1.rotation.w = cos(cmd.yaw/2);
  ...
  // std::cout << "before we call pos_icuas_pub " << std::endl;
  pos_icuas_pub.publish(traj_point);
  // ========================= pub for icuas ========================
}
...
int main(int argc, char **argv)
{
  ...
  pos_icuas_pub = node.advertise<trajectory_msgs::MultiDOFJointTrajectoryPoint>("/ego/red/position_hold/trajectory", 10);
