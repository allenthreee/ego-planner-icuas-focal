...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    // std::cout<<"welcome to ICUAS...!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"<<std::endl;

    /*  fsm param  */
    nh.param("fsm/flight_type", target_type_, -1);
    // std::cout<<"welcome to ICUAS...!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    // <<target_type_<<std::endl;
    ...
    std::cout<<waypoint_num_<<std::endl;
    ...
    stuck_local_minima_pub = nh.advertise<std_msgs::Bool>("/got_stuck", 10);
  ...
  void EGOReplanFSM::checkCollisionCallback(const ros::TimerEvent &e)
  {
    ...
    for (double t = t_cur; t < info->duration_; t += time_step)
    {
      ...
      // If t_cur < t_2_3, 
      // only the first 2/3 partition of the trajectory 
      // is considered valid and will get checked.
        break;
  ...
  bool EGOReplanFSM::callReboundReplan(bool flag_use_poly_init, bool flag_randomPolyTraj)
  {
    ...
    if(!plan_success)
    {
       ...
       stuck_local_minima_pub.publish(temp);
    }
    else
    {
      std_msgs::Bool temp;
